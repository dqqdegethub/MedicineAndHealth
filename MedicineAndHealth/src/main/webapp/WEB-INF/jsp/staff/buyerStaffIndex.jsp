		...
		<div style="height:530px;width:1100px;background-color:#EDEDED;position:absolute;top:70px;left:220px;z-index:99;">
			<div style="height:530px;width:200px;background-color:#FFFFFF;float:left">
				...
				<div style="margin-left:15px">
					<img src="<%=request.getContextPath()%>/statics/images/staffIndexicon5.png" style="width:20px;margin-right:5px;"/>优秀采购员
				</div>
<!-- 				<div style="margin-left:15px">好评率：98.7%</div> -->
			</div>
			<div style="width:900px;float:left">
				...
				<div id="accountManage" style="display:;border-bottom:2px solid #C4C4C4;height:30px;width:95%;margin-left:25px">
					...
					<div id="account2" style="width:280px;height:280px;background-color:white;margin-left:50px;margin-top:100px;float:left;text-align:center;cursor:pointer;">
						<div>
							<img src="<%=request.getContextPath()%>/statics/images/staffIndexP.png" style="padding-bottom:60px;padding-top:80px;width:60px"/>
						</div>
				...
				<div id="businessManage" style="display:none;border-bottom:2px solid #C4C4C4;height:30px;width:95%;margin-left:25px">
					<div id="business1" style="width:280px;height:280px;background-color:white;margin-left:100px;margin-top:100px;float:left;text-align:center;cursor:pointer;">
						...
						<span style="">采购提醒</span>
					</div>
					<div id="business2" style="width:280px;height:280px;background-color:white;margin-left:50px;margin-top:100px;float:left;text-align:center;cursor:pointer;">
						<div>
